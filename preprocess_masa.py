...
def main():
    ...
    # 4. save
    print("\nSaving Dataset...")
    dst_dir = f'output_datasets/masa/{args.output_dataset}/{args.input_dataset}.zarr'
    os.makedirs(f'output_datasets/masa/{args.output_dataset}/', exist_ok=True)
    ...
    new_env = gym.make(
            args.input_dataset, 
            flatten_obs=True,
            data_dir=f'output_datasets/masa/{args.output_dataset}')
